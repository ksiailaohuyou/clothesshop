...
from view.alipay import AliPay
# Create your views here.
...
alipay = AliPay(
    ...
    return_url='http://127.0.0.1:9000/order/alipay/', #
    app_notify_url='http://www.oldbird.pythonanywhere.com/alipay/post'
)
...
class OrderCreatedView(BaseRedirctView):
    ...
    def handle(self,request):
        ...
        for orderitem in orderitems:
            ...
            store.save() # 保存到数据库
        # 根据支付方式，生成字符界面
        param = alipay.direct_pay(out_trade_no=order.sign,subject='clothes',total_amount=str(price))
